...
const Health = () => {
    return (
        <div>
            ...
            <div className="hero-container" data-aos="fade-right" id="ab">
                ...
                <button type="button" data-aos="fade-right" class="rounded-pill btn1-responsive font-weight-bold btn1 btn1-primary" style={{ position: 'absolute', top: '400px', right: '296px' }}>Sign Up For Free</button>
            </div>
                    ...
                    <div className="pb-6 row">
                        <div className="text-center col">
                            <h2 className="h1 mb-5">Get Started Today</h2><button type="button"
                                className="rounded-pill btn1-responsive font-weight-bold btn1 btn1-primary" >Sign Up For Free</button>
                        </div>
                    </div>
                </div>
            </section>
